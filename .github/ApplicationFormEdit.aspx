<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplicationFormEdit.aspx.cs" Inherits="ApplicationFormEdit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>DSMNRU Admission 2020-21</title>
    ...
    <script type="text/javascript" language="javascript">
        function textcopy1() {
            if (document.getElementById('CheckBox1').checked) {
                var str = document.getElementById('paddress').value;
                document.getElementById('maddress').value = str;
            }
        }
        function textcopy2() {
            if (document.getElementById('CheckBox4').checked) {
                var str = document.getElementById('paddress0').value;
                document.getElementById('maddress0').value = str;
            }
        }
        function textcopy3() {
            if (document.getElementById('CheckBox3').checked) {
                var str = document.getElementById('paddress1').value;
                document.getElementById('maddress1').value = str;
            }
        }
...
<body>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <asp:LinkButton ID="LinkButton_dashboard" runat="server" CausesValidation="False" OnClick="LinkButton_dashboard_Click"><span class="fa fa-desktop"></span>Dashboard</asp:LinkButton>--%>
                    </li>
                    ...
                    <li>
                        ...
                        <asp:LinkButton ID="LinkButton_Personal" runat="server" OnClick="LinkButton_Personal_Click" CausesValidation="False"><span class="fa fa-pencil"></span>Personal Details</asp:LinkButton>
                    </li>

                    <li>
                        <%-- <a href="#"><span class="fa fa-pencil"></span>Mailing Address</a>--%>
                        <asp:LinkButton ID="LinkButton_mailing" runat="server" OnClick="LinkButton_mailing_Click" CausesValidation="False"><span class="fa fa-pencil"></span>Mailing Address</asp:LinkButton>
                    </li>
                    <li>
                        <%-- <a href="#"><span class="fa fa-pencil"></span>Academic Qualification</a>--%>
                        <asp:LinkButton ID="LinkButton_qualification" runat="server" OnClick="LinkButton_qualification_Click" CausesValidation="False"><span class="fa fa-pencil"></span>Academic Qualification</asp:LinkButton>
                    </li>
                    <asp:Panel ID="Panel_facility" runat="server" Visible="False">
                        <li>
                            <%--<a href="#"><span class="fa fa-pencil"></span>Desired Facilities</a>--%>
                            <asp:LinkButton ID="LinkButton_fascilities" runat="server" OnClick="LinkButton_fascilities_Click" CausesValidation="False"><span class="fa fa-pencil"></span>Desired Facilities</asp:LinkButton>
                        </li>
                    </asp:Panel>
                    <li>
                        <%--<a href="#"><span class="fa fa-pencil"></span>Signature & Photo Upload</a>--%>
                        <asp:LinkButton ID="LinkButton_upload" runat="server" OnClick="LinkButton_upload_Click" CausesValidation="False"><span class="fa fa-pencil"></span>Photo Upload</asp:LinkButton>
                    </li>
                    <asp:Panel ID="Panel1" runat="server" Visible="false">
                        <li>
                            <%--   <a href="#"><span class="fa fa-pencil"></span>Payment Details</a>--%>
                            <asp:LinkButton ID="LinkButton_payment" runat="server" OnClick="LinkButton_payment_Click" CausesValidation="False"><span class="fa fa-pencil"></span>Payment Details</asp:LinkButton>
                        </li>
                    </asp:Panel>
                    <li>
                        <asp:LinkButton ID="LinkButton_final_submit" runat="server" CausesValidation="False" OnClick="LinkButton_final_submit_Click"><span class="fa fa-pencil"></span>Final Submit</asp:LinkButton>
                    </li>
                    <li>
                    ...
                    <asp:LinkButton ID="LinkButton_Logout" runat="server" OnClick="LinkButton_Logout_Click" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Logout</asp:LinkButton>--%>
                        <asp:LinkButton ID="LinkButton_logout" runat="server" OnClick="LinkButton_logout_Click" CausesValidation="False"><span class="fa fa-sign-out"></span>Logout</asp:LinkButton>
                    </li>

                    <asp:Label ID="Label_Fee_Check" runat="server" Text="Label" Visible="False"></asp:Label>
                </ul>
                <!-- END X-NAVIGATION -->
            </div>
            <!-- END PAGE SIDEBAR -->
            ...
            <div class="page-content">
                ...
                <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
                    ...
                    <li class="xn-icon-button pull-right">
                        ...
                        <asp:LinkButton ID="LinkButton_logout_right" runat="server" OnClick="LinkButton_logout_Click" CausesValidation="False"><span class="fa fa-sign-out"></span></asp:LinkButton>
                    </li>
                    <!-- END SIGN OUT -->
                    <!-- MESSAGES -->
                                                ...
                                                <table class="table datatable">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="pname" runat="server" ReadOnly="True" Width="171px"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="pcode" runat="server" ReadOnly="True" Width="169px"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="username" runat="server" ReadOnly="True" Width="168px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="Label_regno" runat="server" ReadOnly="True" Width="167px"></asp:TextBox></td>
                                                    </tr>
                                                </table>
                                        ...
                                        <asp:View ID="View2" runat="server">
                                            ...
                                            <table class="table datatable">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="blood" runat="server" Height="27px" Width="206px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="Domocile" runat="server" Height="27px" Width="206px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="auto-style2">
                                                        <asp:DropDownList ID="gender" runat="server" Style="height: 27px; width: 206px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="DropDownList_Nationality" runat="server" OnSelectedIndexChanged="DropDownList_Nationality_SelectedIndexChanged" AutoPostBack="True" Height="27px" Width="206px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="state" runat="server" AutoPostBack="True" Height="27px" Width="206px">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="state" ErrorMessage="* Select State" ForeColor="#CC0000" InitialValue="---Select Other State---"></asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <%-- <tr>
                                                    <td>&nbsp;</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:DropDownList ID="religion" runat="server" Height="27px" Width="206px">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server"
                                                            ControlToValidate="religion" ErrorMessage="* Select Religion" ForeColor="#CC0000"></asp:RequiredFieldValidator>
                                                        &nbsp;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="minority" runat="server" Height="27px" Width="206px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="mstatus" runat="server" Height="27px" Width="206px">
                                                    ...
                                                    <td colspan="2">
                                                        <table class="table datatable">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="category" runat="server" AutoPostBack="True" OnSelectedIndexChanged="category_SelectedIndexChanged" Height="27px" Width="200px">
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="ccode" runat="server"
                                                                        ReadOnly="True" Height="27px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtempname" runat="server" Visible="False" Height="27px" Width="206px"></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="disability" runat="server"
                                                                        AutoPostBack="True" OnSelectedIndexChanged="disability_SelectedIndexChanged" Height="27px" Width="206px">
                                                                    ...
                                                                    <asp:TextBox ID="tb_disability" runat="server" placeholder="Enter Other Disability" Visible="False" Height="27px" Width="118px"></asp:TextBox>


                                                                    <asp:Label ID="Label_Disability" runat="server" Visible="False"></asp:Label>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="dcode" runat="server"
                                                                        placeholder="Enter Disability" ReadOnly="True" Height="27px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="Label35" runat="server"
                                                                        Text="Dependent of Freedom Fighters"></asp:Label>
                                                                </td>
                                                                <td>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <table class="nav-justified">
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="Label_fee_amount" runat="server"></asp:Label>
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="Label_otherstate_fee" runat="server"></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td>
                                                        <asp:Button ID="personl_detail_btnSubmit" runat="server" CssClass="btn btn-primary"
                                                            Text=" Save " OnClick="personl_detail_btnSubmit_Click" Width="150px" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                        ...
                                        <asp:View ID="View3" runat="server">
                                            ...
                                            <table class="table datatable">
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <asp:TextBox ID="paddress" AutoPostBack="true" CssClass="text-uppercase" runat="server" placeholder="Enter Address" Width="200px"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ControlToValidate="paddress" ErrorMessage="* Permanent Address Required" ForeColor="#CC0000"></asp:RequiredFieldValidator>
                                                ...
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td colspan="2">
                                                        <asp:TextBox ID="paddress0" AutoPostBack="true" CssClass="text-uppercase" runat="server" placeholder="Enter Address" Width="200px"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td colspan="2">
                                                        <asp:TextBox ID="paddress1" AutoPostBack="true" CssClass="text-uppercase" runat="server" placeholder="Enter Address" Width="200px"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <asp:TextBox ID="maddress" runat="server" placeholder="Enter Address" CssClass="text-uppercase" Width="200px"></asp:TextBox>
                                                        <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="true" OnCheckedChanged="CheckBox1_CheckedChanged" Text="Keep Mailing Address same as Permanent Address" />
                                                ...
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td colspan="2">
                                                        <asp:TextBox ID="maddress0" CssClass="text-uppercase" runat="server" placeholder="Enter Address" Width="200px"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td colspan="2">
                                                        <asp:TextBox ID="maddress1" CssClass="text-uppercase" runat="server" placeholder="Enter Address" Width="200px"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td colspan="2">
                                                        <asp:Button ID="mailing_address" runat="server" CssClass="btn btn-primary"
                                                            Text="Update Details" OnClick="mailing_address_Click" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <table class="nav-justified">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <strong>* Appeared in Basic Eligibility Examination and Result Awaited:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label
                                                                ID="Label_AppearedStatus" runat="server" Text="No"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            ...
                                                            <br />
                                                            * If Applicant is in final year in required qualification then fill <strong>Appearing </strong>in Reference No column.
                                                            <br />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                                ...
                                                                <table class="nav-justified">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ba1c_1" ErrorMessage="*Please Select 1st Subject." ForeColor="Red" InitialValue="NA" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                                    
                                                                        </td>
                                                                        <td>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="ba1c_2" ErrorMessage="*Please Select 2nd Subject" ForeColor="Red" InitialValue="NA" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                                        </td>
                                                                        <td>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" ControlToValidate="ba1c_3" ErrorMessage="*Please Select 3rd Subject" ForeColor="Red" InitialValue="NA" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                        ...
                                                        <td colspan="2">
                                                            <asp:Panel ID="bahindPanel" runat="server" Visible="False">
                                                                <table class="nav-justified">
                                                                    <tr>
                                                                        <td colspan="4">
                                                                            <asp:Label ID="Label27" runat="server" CssClass="col-lg-2 control-label" Font-Bold="True" Text="For BA Programme"></asp:Label>
                                                                            <asp:Label ID="Label28" runat="server" ForeColor="Red" Text="(Please select the choice of Subject as per the availability of course in the University/Affiliated College as given in the Admission Brochure 2020-21.)" Visible="False"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width: 25%;">
                                                                            <asp:Label ID="Label29" runat="server" CssClass="col-lg-2 control-label" Text="Ist Choice"></asp:Label>
                                                                        </td>
                                                                        <td style="width: 25%;">
                                                                    ...
                                                                    <tr>
                                                                        <td>&nbsp;</td>
                                                                        <td>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="bahind1c_1" ErrorMessage="*Please Select 1st Subject" ForeColor="Red" InitialValue="NA" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                                        </td>
                                                                        <td>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" ControlToValidate="bahind1c_2" ErrorMessage="*Please Select 2nd Subject" ForeColor="Red" InitialValue="NA" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label39" runat="server" CssClass="col-lg-2 control-label" Text="IInd Choice"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label40" runat="server" CssClass="col-lg-2 control-label" Text="IIIrd Choice"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:Panel ID="bscPanel" runat="server" Visible="False">
                                                                <table class="nav-justified">
                                                                    <tr>
                                                                        <td colspan="4">
                                                                            <asp:Label ID="Label23" runat="server" CssClass="col-lg-2 control-label" Font-Bold="True" Text="For BSC Programme"></asp:Label>
                                                                            <asp:Label ID="Label24" runat="server" ForeColor="Red" Text="(Please select the choice of Subject as per the availability of course in the University/Affiliated College as given in the Admission Brochure 2020-21.)" Visible="False"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label26" runat="server" CssClass="col-lg-2 control-label" Text="Enter Choice"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                                        ...
                                                                        <tr>
                                                                            <td>&nbsp;</td>
                                                                            <td>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="bsc1c_1" ErrorMessage="*Atleast one subject Group selection required." ForeColor="Red" InitialValue="NA" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                                            </td>
                                                                            <td>&nbsp;</td>
                                                                            <td>&nbsp;</td>
                                                                        </tr>
                                                        ...
                                                        <td colspan="2">
                                                            <asp:Panel ID="dedPanel" runat="server" Visible="False">
                                                                <table class="nav-justified">
                                                                    <tr>
                                                                        <td colspan="4">
                                                                            <asp:Label ID="Label61" runat="server" CssClass="col-lg-2 control-label" Font-Bold="True" Text="For D.Ed. (Special Education) Programme (V.I./ H.I./ M.R.)"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label55" runat="server" CssClass="col-lg-2 control-label" Text="Enter Choice"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <td colspan="2">
                                                            <asp:Panel ID="bedrPanel" runat="server" Visible="False">
                                                                <table class="nav-justified">
                                                                    <tr>
                                                                        <td colspan="4">
                                                                            <asp:Label ID="Label64" runat="server" CssClass="col-lg-2 control-label" Font-Bold="True" Text="For B.Ed. (Special Education) Programme (V.I./ H.I./ M.R.)"></asp:Label>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label94" runat="server" CssClass="col-lg-2 control-label" Text="Enter Choice"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <td colspan="2">
                                                            <asp:Panel ID="bedodlPanel" runat="server" Visible="False">
                                                                <table class="nav-justified">
                                                                    <tr>
                                                                        <td colspan="4">
                                                                            <asp:Label ID="Label65" runat="server" CssClass="col-lg-2 control-label" Font-Bold="True" Text="For B.Ed.(ODL) (Special Education) Programme (V.I./ H.I./ M.R.)"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label70" runat="server" CssClass="col-lg-2 control-label" Text="Enter Choice"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <td colspan="2">
                                                            <asp:Panel ID="bpoPanel" runat="server" Visible="False">
                                                                <table class="nav-justified">
                                                                    <tr>
                                                                        <td colspan="4">
                                                                            <asp:Label ID="Label66" runat="server" CssClass="col-lg-2 control-label" Font-Bold="True" Text="For B.ASLP/B.P.O. (Special Education) Programme "></asp:Label>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label71" runat="server" CssClass="col-lg-2 control-label" Text="Enter Choice"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <td colspan="2">
                                                            <asp:Panel ID="btechPanel" runat="server" Visible="False">
                                                                <table class="nav-justified">
                                                                    <tr>
                                                                        <td colspan="6">
                                                                            <asp:Label ID="Label67" runat="server" CssClass="col-lg-2 control-label" Font-Bold="True" Text="For BTech Programme "></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>&nbsp;&nbsp;&nbsp;
                                                                            <asp:Label ID="Label96" runat="server" Font-Bold="False" Font-Size="13px" Text="Enter Choice"></asp:Label>
                                                                        </td>
                                                                        <td align="left">
                                                        ...
                                                        <td colspan="2">
                                                            <asp:Panel ID="phdPanel" runat="server" Visible="False">
                                                                <table class="nav-justified">
                                                                    <tr>
                                                                        <td colspan="6">
                                                                            <asp:Label ID="Label80" runat="server" CssClass="col-lg-2 control-label" Font-Bold="True" Text="For Ph.D. Programme Only"></asp:Label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="6">
                                                                            <table class="left">
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="left" rowspan="2">
                                                                                        <asp:Label ID="Label76" runat="server" Font-Bold="False" Font-Size="14px" Text="Subject(s) Taught"></asp:Label>
                                                                                    </td>
                                                                                    <td align="center" colspan="2">
                                                                                        <asp:Label ID="Label75" runat="server" Font-Bold="False" Font-Size="14px" Text="Duration"></asp:Label>
                                                                                    </td>
                                                                                    <td rowspan="2">
                                                                                        <asp:Label ID="Label78" runat="server" Font-Bold="False" Font-Size="14px" Text="Year &amp; Months"></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left">
                                                                                        <asp:Label ID="Label79" runat="server" Font-Bold="False" Font-Size="14px" Text="From"></asp:Label>
                                                                                    </td>
                                                                                    <td align="left">
                                                                                        <asp:Label ID="Label77" runat="server" Font-Bold="False" Font-Size="14px" Text="To"></asp:Label>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left">
                                                                                        <asp:TextBox ID="TextBox12" runat="server" CssClass="form-control" placeholder="Enter Full Name"></asp:TextBox>
                                                                                    </td>
                                                                                    <td align="left">
                                                                                        <asp:TextBox ID="TextBox13" runat="server" CssClass="form-control" placeholder="Enter Subject(s)"></asp:TextBox>
                                                                                    </td>
                                                                                    <td align="left">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" colspan="2">
                                                                                        <asp:Label ID="Label74" runat="server" Font-Bold="False" Font-Size="14px" Text="Name and Address of the Employer"></asp:Label>
                                                                                    </td>
                                                                                    <td align="left" colspan="3">
                                                                                        <asp:TextBox ID="phd_emp_name_add" runat="server" CssClass="form-control" placeholder="Enter Name &amp; Address" TextMode="MultiLine"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <asp:Button ID="Education_Button" runat="server" CssClass="btn btn-primary"
                                            OnClick="Education_Button_Click" Text="Update Details" Width="150px" />
                                    </td>
                                </tr>
                                        ...
                                        <asp:View ID="View5" runat="server">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading panel-heading-custom">
                                                    <div class="panel-title">
                                                        <strong>Facilities Details</strong><i class="fa fa-pencil pull-right"></i>
                                                    </div>
                                                </div>
                                            </div>
                                            <table class="table datatable">
                                            ...
                                            <table class="table datatable">
                                                <tr>
                                                    <td colspan="4">&nbsp;&nbsp;*&nbsp;Said facilities will be provided as per the availability and rules of the 
                                                    University.</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3" align="center">
                                                        <asp:Button ID="Facility_Button" runat="server" CssClass="btn btn-primary"
                                                            Text="Update Details" OnClick="Facility_Button_Click" Width="150px" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
                                        ...
                                        <asp:View ID="View6" runat="server">
                                            <div class="panel panel-default">
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label115" runat="server" ForeColor="Red" Text="Note: *Upload jpg/jpeg file only (Max size 80 KB)&nbsp; for Photo/Signature and PDF file only (Max size 300 KB)&nbsp; for Documents."></asp:Label>
                                                </strong>
                                            </div>
                                            <table class="nav-justified">
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="auto-style8">
                                                        <asp:Label ID="Label9" runat="server" Text="Photo Upload"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:FileUpload ID="FileUpload1" runat="server" accept=".png,.jpg,.jpeg,.gif" />
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator27" runat="server" ControlToValidate="FileUpload1" ErrorMessage="* Required Field" ForeColor="#CC3300"></asp:RequiredFieldValidator>
                                                  <%--      <asp:RegularExpressionValidator ID="RegularExpressionValidator273" runat="server" ControlToValidate="FileUpload1" ErrorMessage="* Upload jpg/jpeg file only." ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.jpg|.JPG|.jpeg|.JPEG)$"></asp:RegularExpressionValidator>
                                                    --%>    
                                                        <asp:CustomValidator ID="FileUpload1_SizeValidator" runat="server" ControlToValidate="FileUpload1" ErrorMessage="* File size should not be greater than 80KB" ForeColor="#CC3300" OnServerValidate="FileUpload1_SizeValidator_serverValidate"></asp:CustomValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style8">
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator35" runat="server" ControlToValidate="FileUpload2" ErrorMessage="* Required Field" ForeColor="#CC3300"></asp:RequiredFieldValidator>
                                                    <%--    <asp:RegularExpressionValidator ID="RegularExpressionValidator274" runat="server" ControlToValidate="FileUpload2" ErrorMessage="* Upload jpg/jpeg file only." ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.jpg|.JPG|.jpeg|.JPEG)$"></asp:RegularExpressionValidator>
                                                        --%> 
                                                        <asp:CustomValidator ID="FileUpload2_SizeValidator" runat="server" ControlToValidate="FileUpload2" ErrorMessage="* File size should not be greater than 80KB" ForeColor="#CC3300" OnServerValidate="FileUpload2_SizeValidator_serverValidate"></asp:CustomValidator>
                                                        <br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style8">
                                                        <asp:Label ID="Label107" runat="server" Text="X Marksheet Upload"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:FileUpload ID="FileUpload3" runat="server" accept=".pdf"/>
                                                       ...
                                                       <%-- <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="FileUpload3" ErrorMessage="* Upload pdf/PDF file only." ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$"></asp:RegularExpressionValidator>
                                                        --%>  
                                                           <asp:CustomValidator ID="FileUpload3_SizeValidator" runat="server" ControlToValidate="FileUpload3" ErrorMessage="* File size should not be greater than 300KB" ForeColor="#CC3300" OnServerValidate="FileUpload3_SizeValidator_serverValidate"></asp:CustomValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style8">
                                                        <asp:Label ID="Label108" runat="server" Text="XII Marksheet Upload"></asp:Label>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="FileUpload4" ErrorMessage="* Upload pdf/PDF file only." ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$"></asp:RegularExpressionValidator>
                                                        <asp:CustomValidator ID="FileUpload4_SizeValidator" runat="server" ControlToValidate="FileUpload4" ErrorMessage="* File size should not be greater than 300KB" ForeColor="#CC3300" OnServerValidate="FileUpload4_SizeValidator_serverValidate"></asp:CustomValidator>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td class="auto-style8">
                                                        <asp:Label ID="Label109" runat="server" Text="UG Marksheet Upload"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:FileUpload ID="FileUpload5" runat="server" />
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="FileUpload5" ErrorMessage="* Upload pdf/PDF file only." ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$"></asp:RegularExpressionValidator>
                                                        <asp:CustomValidator ID="FileUpload5_SizeValidator" runat="server" ControlToValidate="FileUpload5" ErrorMessage="* File size should not be greater than 300KB" ForeColor="#CC3300" OnServerValidate="FileUpload5_SizeValidator_serverValidate"></asp:CustomValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style8">
                                                        <asp:Label ID="Label110" runat="server" Text="Other Marksheet Upload"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:FileUpload ID="FileUpload6" runat="server" />
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="FileUpload6" ErrorMessage="* Upload pdf/PDF file only." ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$"></asp:RegularExpressionValidator>
                                                        <asp:CustomValidator ID="FileUpload6_SizeValidator" runat="server" ControlToValidate="FileUpload6" ErrorMessage="* File size should not be greater than 300KB" ForeColor="#CC3300" OnServerValidate="FileUpload6_SizeValidator_serverValidate"></asp:CustomValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style8">
                                                        <asp:Label ID="Label111" runat="server" Text="Category Certificate Upload"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:FileUpload ID="FileUpload7" runat="server" />
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="FileUpload7" ErrorMessage="* Upload pdf/PDF file only." ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$"></asp:RegularExpressionValidator>
                                                        <asp:CustomValidator ID="FileUpload7_SizeValidator" runat="server" ControlToValidate="FileUpload7" ErrorMessage="* File size should not be greater than 300KB" ForeColor="#CC3300" OnServerValidate="FileUpload7_SizeValidator_serverValidate"></asp:CustomValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style8">
                                                        <asp:Label ID="Label112" runat="server" Text="Disability Certificate Upload"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:FileUpload ID="FileUpload8" runat="server" />
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator272" runat="server" ControlToValidate="FileUpload8" ErrorMessage="* Upload pdf/PDF file only." ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$"></asp:RegularExpressionValidator>
                                                        <asp:CustomValidator ID="FileUpload8_SizeValidator" runat="server" ControlToValidate="FileUpload8" ErrorMessage="* File size should not be greater than 300KB" ForeColor="#CC3300" OnServerValidate="FileUpload8_SizeValidator_serverValidate"></asp:CustomValidator>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator275" runat="server" ControlToValidate="FileUpload9" ErrorMessage="* Upload pdf/PDF file only. " ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$" EnableClientScript="False"></asp:RegularExpressionValidator>
                                                        <asp:CustomValidator ID="FileUpload9_SizeValidator" runat="server" ControlToValidate="FileUpload9" ErrorMessage="* File size should not be greater than 300KB" ForeColor="#CC3300" OnServerValidate="FileUpload9_SizeValidator_serverValidate"></asp:CustomValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="auto-style8">
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator276" runat="server" ControlToValidate="FileUpload10" ErrorMessage="* Upload pdf/PDF file only." ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$" Enabled="False"></asp:RegularExpressionValidator>
                                                        <asp:CustomValidator ID="FileUpload10_SizeValidator" runat="server" ControlToValidate="FileUpload10" ErrorMessage="* File size should not be greater than 300KB" ForeColor="#CC3300" OnServerValidate="FileUpload10_SizeValidator_serverValidate"></asp:CustomValidator>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td class="auto-style8">
                                                        <asp:Image ID="Photo_img" runat="server" Height="154px" Width="149px" />
                                                    </td>
                                                    <td>
                                                        <asp:Image ID="Signature_img" runat="server" Height="154px" Width="149px" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="Image_Upload_button" runat="server" CssClass="btn btn-primary"
                                                            Text="Upload" OnClick="Image_Upload_button_Click" />
                                                        &nbsp;
                                                    ...
                                                    <td>
                                                        <asp:Button ID="gotonextbutton" runat="server" CssClass="btn btn-primary"
                                                            ...
                                                            Visible="False" OnClick="gotonextbutton_Click" />
                                            ...
                                            <table class="table datatable">
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label1_ddno" runat="server"
                                                            Text="DD No"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="TB_DD_No" runat="server"
                                                            placeholder="Enter DD No."></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator_ddno" runat="server"
                                                            ControlToValidate="TB_DD_No" ErrorMessage="* Permanent Address Required"
                                                            ForeColor="#CC0000"></asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="TB_BankName" runat="server"
                                                            placeholder="Enter Mailing Address"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator22_bankname" runat="server"
                                                            ControlToValidate="TB_BankName" ErrorMessage="* Mailing Address Required"
                                                            ForeColor="#CC0000"></asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        &nbsp;<asp:RangeValidator ID="valrDate" runat="server" ControlToValidate="TB_DD_Date" MinimumValue="17/03/2018" MaximumValue="17/04/2018" Type="Date" text="Invalid Date" Display="Dynamic" ForeColor="#CC0000"/>--%><asp:RangeValidator ID="valrDate" runat="server" ControlToValidate="TB_DD_Date" MinimumValue="2018-03-17" MaximumValue="2018-06-17" Type="Date" Text="Invalid Date" Display="Dynamic" ForeColor="#CC0000" />
                                                    </td>
                                                </tr>
                                        ...
                                        <br />
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label25" runat="server" Text="Note: After final submit you can't change your details." ForeColor="Red"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Lbl_CourseFinalFee" runat="server" Text="" Visible="False"></asp:Label>&nbsp;
                                                        <asp:Label ID="Lbl_Exception" runat="server" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <asp:Button ID="accept_submit_button" runat="server" CssClass="btn btn-primary"
                                                            Text="Accept &amp; Final Submit" OnClick="accept_submit_button_Click" Visible="False" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>&nbsp;</td>
    ...
    <%--                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator268" runat="server" ControlToValidate="FileUpload4" ErrorMessage="* Upload pdf/PDF file only (Max size 300 KB) " ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$"></asp:RegularExpressionValidator>--%>

    <%--                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator269" runat="server" ControlToValidate="FileUpload5" ErrorMessage="* Upload pdf/PDF file only (Max size 300 KB) " ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$"></asp:RegularExpressionValidator>--%><%--                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator270" runat="server" ControlToValidate="FileUpload6" ErrorMessage="* Upload pdf/PDF file only (Max size 300 KB) " ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$"></asp:RegularExpressionValidator>--%>
                            </div>
                        </div>

                        <%--                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator271" runat="server" ControlToValidate="FileUpload7" ErrorMessage="* Upload pdf/PDF file only (Max size 300 KB) " ForeColor="#CC3300" ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.pdf|.PDF)$"></asp:RegularExpressionValidator>--%>
                    </div>
    ...
    <div class="message-box animated fadeIn" data-sound="alert" id="mb-signout">
        <div class="mb-container">
            <div class="mb-middle">
                <div class="mb-title">
                    <span class="fa fa-sign-out"></span>Log class="mb-title">lass="mb-title">fa-sign-out"> ?           
        ...
        <!-- START PRELOADS -->
        <%--<asp:CompareValidator ID="valcDate" runat="server" ControlToValidate="TB_DD_Date" Display="Dynamic" ErrorMessage="(dd/mm/yyyy)" ForeColor="#CC0000" Operator="DataTypeCheck" Type="Date"></asp:CompareValidator>
                                                        &nbsp;<asp:RangeValidator ID="valrDate" runat="server" ControlToValidate="TB_DD_Date" MinimumValue="17/03/2018" MaximumValue="17/04/2018" Type="Date" text="Invalid Date" Display="Dynamic" ForeColor="#CC0000"/>--%>
        <!-- END PRELOADS -->
        ...
        <%--<div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="col-md-6 col-xs-12" />
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="password" class="col-md-6 col-xs-12" />
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="col-md-6 col-xs-12 datepicker" value="2014-11-01">
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <textarea class="col-md-6 col-xs-12" rows="5"></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <select class="col-md-6 col-xs-12 select">
